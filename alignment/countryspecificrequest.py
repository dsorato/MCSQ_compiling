...
class ESSCountrySpecificR01():
	"""
	Item names of country specific questions in ESS round 1.
	"""
	item_names = ['B14', 'B25b', 'B27', 'C10', 'C12', 'F6', 'F34', 'F45', 'F51']
...
class ESSCountrySpecificR05():
	"""
	Item names of country specific questions in ESS round 5.
	"""
	item_names = ['B12', 'B20b', 'B22', 'C18', 'C20', 'F15', 'F45', 'F58', 'F64']
	item_names = [x.lower() for x in item_names]


class ESSCountrySpecificR06():
	"""
	Item names of country specific questions in ESS round 6.
	"""
	item_names = ['B10', 'B18b', 'C10', 'C12','F15', 'F44', 'F52', 'F56']
	item_names = [x.lower() for x in item_names]
...
class ESSCountrySpecificR08():
	"""
	Item names of country specific questions in ESS round 9.
	"""
	item_names = ['B14', 'B24', 'C12', 'C14', 'F15', 'F44', 'F52','F56', 'F61']
	item_names = [x.lower() for x in item_names]

class ESSCountrySpecificR09():
	"""
	Item names of country specific questions in ESS round 9.
	"""
